...
// NBCable is a dcim.Cable connecting exactly two interfaces (the only
// shape this package creates and returns - Netbox cables can in principle
...
// NBVlanGroup is an ipam.VLANGroup row. CreateVlanGroup always creates
// groups as global (unscoped).
