...
func GUI(p *GuiParams) error {
	...
	api.GET("/certs-config", ctrl.ApiCertsConfig, ctrl.RequireAPIAuth, ctrl.RequireAdminOrServiceToken)
	...
	manufacturers_ := NewSecureCRUDHandler[models.Manufacturer, models.ManufacturerDTO](DB)
	api.GET("/dcim/manufacturers", manufacturers_.GetAll, ctrl.RequireAPIAuth, ctrl.RequireRead)
	api.GET("/dcim/manufacturers/:id", manufacturers_.GetOne, ctrl.RequireAPIAuth, ctrl.RequireRead)
	api.POST("/dcim/manufacturers", manufacturers_.Create, ctrl.RequireAPIAuth, ctrl.RequireWrite)
	api.PUT("/dcim/manufacturers/:id", ctrl.guardFactumCatalog("manufacturer", manufacturers_.Update), ctrl.RequireAPIAuth, ctrl.RequireWrite)
	api.DELETE("/dcim/manufacturers/:id", ctrl.guardFactumCatalog("manufacturer", manufacturers_.Delete), ctrl.RequireAPIAuth, ctrl.RequireWrite)

	deviceTypes_ := NewSecureCRUDHandler[models.DeviceType, models.DeviceTypeDTO](DB)
	api.GET("/dcim/device-types", deviceTypes_.GetAll, ctrl.RequireAPIAuth, ctrl.RequireRead)
	api.GET("/dcim/device-types/:id", deviceTypes_.GetOne, ctrl.RequireAPIAuth, ctrl.RequireRead)
	api.POST("/dcim/device-types", deviceTypes_.Create, ctrl.RequireAPIAuth, ctrl.RequireWrite)
	api.PUT("/dcim/device-types/:id", ctrl.guardFactumCatalog("device type", ctrl.ApiDeviceTypeUpdateChecked), ctrl.RequireAPIAuth, ctrl.RequireWrite)
	...
	api.DELETE("/dcim/racks/:id", ctrl.ApiDCIMRackDelete, ctrl.RequireAPIAuth, ctrl.RequireWrite)
	api.GET("/dcim/racks/:id/elevation", ctrl.ApiDCIMRackElevation, ctrl.RequireAPIAuth, ctrl.RequireRead)
	api.PUT("/dcim/devices/:id/placement", ctrl.ApiDCIMDevicePlace, ctrl.RequireAPIAuth, ctrl.RequireWrite)
	api.DELETE("/dcim/devices/:id/placement", ctrl.ApiDCIMDeviceUnmount, ctrl.RequireAPIAuth, ctrl.RequireWrite)
	...
	api.POST("/dcim/connections", ctrl.ApiDCIMConnectionCreate, ctrl.RequireAPIAuth, ctrl.RequireWrite)
	api.PUT("/dcim/connections/:id", ctrl.ApiDCIMConnectionUpdate, ctrl.RequireAPIAuth, ctrl.RequireWrite)
	api.DELETE("/dcim/connections/:id", ctrl.ApiDCIMConnectionDelete, ctrl.RequireAPIAuth, ctrl.RequireWrite)
	api.GET("/dcim/connection-view-layouts/:scope", ctrl.ApiDCIMConnectionLayoutGet, ctrl.RequireAPIAuth, ctrl.RequireRead)
	api.PUT("/dcim/connection-view-layouts/:scope", ctrl.ApiDCIMConnectionLayoutPut, ctrl.RequireAPIAuth, ctrl.RequireWrite)
	...
	certg.POST("/accounts", ctrl.ApiCertAccountCreate, ctrl.RequireWrite)
	certg.GET("/accounts/:id", ctrl.ApiCertAccountGet, ctrl.RequireRead)
	certg.PUT("/accounts/:id", ctrl.ApiCertAccountUpdate, ctrl.RequireWrite)
	certg.DELETE("/accounts/:id", ctrl.ApiCertAccountDelete, ctrl.RequireWrite)
	certg.GET("/challenges", ctrl.ApiCertChallengeList, ctrl.RequireRead)
	certg.POST("/challenges", ctrl.ApiCertChallengeCreate, ctrl.RequireWrite)
	certg.GET("/challenges/:id", ctrl.ApiCertChallengeGet, ctrl.RequireRead)
	certg.PUT("/challenges/:id", ctrl.ApiCertChallengeUpdate, ctrl.RequireWrite)
	certg.DELETE("/challenges/:id", ctrl.ApiCertChallengeDelete, ctrl.RequireWrite)
	certg.GET("/certificates", ctrl.ApiCertificateList, ctrl.RequireRead)
	certg.POST("/certificates", ctrl.ApiCertificateCreate, ctrl.RequireWrite)
	certg.GET("/certificates/:id", ctrl.ApiCertificateGet, ctrl.RequireRead)
	certg.PUT("/certificates/:id", ctrl.ApiCertificateUpdate, ctrl.RequireWrite)
	certg.DELETE("/certificates/:id", ctrl.ApiCertificateDelete, ctrl.RequireWrite)

	dnsg := api.Group("/dns", ctrl.RequireAPIAuth, ctrl.RequireDnsZonesEnabled)
	dnsg.GET("/soa-templates", ctrl.ApiDnsSOAList, ctrl.RequireRead)
	dnsg.POST("/soa-templates", ctrl.ApiDnsSOACreate, ctrl.RequireWrite)
	dnsg.GET("/soa-templates/:id", ctrl.ApiDnsSOAGet, ctrl.RequireRead)
	dnsg.PUT("/soa-templates/:id", ctrl.ApiDnsSOAUpdate, ctrl.RequireWrite)
	dnsg.DELETE("/soa-templates/:id", ctrl.ApiDnsSOADelete, ctrl.RequireWrite)
	dnsg.GET("/dnssec-policies", ctrl.ApiDnsPolicyList, ctrl.RequireRead)
	dnsg.POST("/dnssec-policies", ctrl.ApiDnsPolicyCreate, ctrl.RequireWrite)
	dnsg.GET("/dnssec-policies/:id", ctrl.ApiDnsPolicyGet, ctrl.RequireRead)
	dnsg.PUT("/dnssec-policies/:id", ctrl.ApiDnsPolicyUpdate, ctrl.RequireWrite)
	dnsg.DELETE("/dnssec-policies/:id", ctrl.ApiDnsPolicyDelete, ctrl.RequireWrite)
	dnsg.GET("/templates", ctrl.ApiDnsTemplateList, ctrl.RequireRead)
	dnsg.POST("/templates", ctrl.ApiDnsTemplateCreate, ctrl.RequireWrite)
	dnsg.GET("/templates/:id", ctrl.ApiDnsTemplateGet, ctrl.RequireRead)
	dnsg.PUT("/templates/:id", ctrl.ApiDnsTemplateUpdate, ctrl.RequireWrite)
	dnsg.DELETE("/templates/:id", ctrl.ApiDnsTemplateDelete, ctrl.RequireWrite)
	dnsg.GET("/zones", ctrl.ApiDnsZoneList, ctrl.RequireRead)
	dnsg.POST("/zones", ctrl.ApiDnsZoneCreate, ctrl.RequireWrite)
	...
	cfg.GET("/scopes/:id/features", ctrl.ApiConfigFeatureList, ctrl.RequireRead)
	cfg.POST("/scopes/:id/features", ctrl.ApiConfigFeatureCreate, ctrl.RequireWrite)
	cfg.PUT("/features/:id", ctrl.ApiConfigFeatureUpdate, ctrl.RequireWrite)
	cfg.DELETE("/features/:id", ctrl.ApiConfigFeatureDelete, ctrl.RequireWrite)
	...
	cfg.PUT("/platform-packs/:id", ctrl.ApiConfigLegacyGone, ctrl.RequireWrite)
	cfg.DELETE("/platform-packs/:id", ctrl.ApiConfigLegacyGone, ctrl.RequireWrite)
	...
	cfg.PUT("/templates/:id", ctrl.ApiConfigLegacyGone, ctrl.RequireWrite)
	cfg.DELETE("/templates/:id", ctrl.ApiConfigLegacyGone, ctrl.RequireWrite)
