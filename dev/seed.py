...
UPDATE settings SET
  ...
  dhcp_host_template = 'isc_kea',
  dhcp_kea_type = 'isc_kea',
  dhcp_kea4_config_dir = {_sql_lit("/etc/kea")},
  dhcp_kea4_include_file = 'kea-dhcp4.dnsmgr2.json',
  dhcp_kea4_tmp_dir = {_sql_lit("/var/lib/dnsmgr2")},
  dhcp_kea4_cmd_restart = 'true',
  dhcp_kea6_config_dir = {_sql_lit("/etc/kea")},
  dhcp_kea6_include_file = 'kea-dhcp6.dnsmgr2.json',
  dhcp_kea6_tmp_dir = {_sql_lit("/var/lib/dnsmgr2")},
  dhcp_kea6_cmd_restart = 'true',
  icinga_enabled = true,
